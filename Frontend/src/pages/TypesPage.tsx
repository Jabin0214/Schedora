...
const TypesPage: React.FC = () => {
  ...
  return (
    <div>
      {/* ── Toolbar ── */}
      <div style={{ marginBottom: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingBottom: 12, borderBottom: '1px solid #30363d' }}>
        <IndTitle>Task Types</IndTitle>
      ...
      <Spin spinning={loading}>
        <div style={{ border: '1px solid #30363d', borderTop: '2px solid #00d4ff', borderRadius: 2, background: '#161b22' }}>
          {/* Header */}
          <div style={{ ...rowStyle, background: '#0d1117', fontSize: '10px', color: '#484f58', letterSpacing: '1.5px', textTransform: 'uppercase' }}>
            <div>ID</div>
            <div>Name</div>
            <div>Color</div>
            <div>Actions</div>
